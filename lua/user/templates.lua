...
private:
      ...
      local source = string.format([[#include "%s.h"
...
]], include_path, namespace, name, name, name, name, namespace)
...
]], include_path, namespace, name, name, name, namespace)
...
// TODO: Add declarations
  ...
  
  {
    ...
    generator = function(name, path)
      ...
      local source = string.format([[namespace %s {
...
if __name__ == "__main__":
  ...
  
  {
    ...
    ext = {".rs"},
    generator = function(name, path)
      local module = string.format([[pub struct %s {
}
