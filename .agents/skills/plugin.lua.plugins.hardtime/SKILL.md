# Plugin.lua.plugins.hardtime API Reference

This file is generated for source `lua/plugins/hardtime.lua`.
...
- `m4xshen/hardtime.nvim` (skill: `skills/hardtime.nvim/SKILL.md`)
