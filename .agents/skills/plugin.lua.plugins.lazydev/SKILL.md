# Plugin.lua.plugins.lazydev API Reference

This file is generated for source `lua/plugins/lazydev.lua`.
...
- `folke/lazydev.nvim` (skill: `skills/lazydev.nvim/SKILL.md`)
