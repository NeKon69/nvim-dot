# Plugin.persistence API Reference
...
- `folke/persistence.nvim` (skill: `.agents/skills/persistence.nvim/SKILL.md`)

- `persistence` (skill: `.agents/skills/persistence.nvim/SKILL.md`)
