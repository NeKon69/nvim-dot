# Plugin.lua.plugins.dap API Reference
...
- `Weissle/persistent-breakpoints.nvim` (skill: `skills/persistent-breakpoints.nvim/SKILL.md`)
...
- `mfussenegger/nvim-dap` (skill: `skills/nvim-dap/SKILL.md`)

- `nvim-dap-virtual-text`

- `overseer` (skill: `skills/overseer.nvim/SKILL.md`)

- `persistent-breakpoints` (skill: `skills/persistent-breakpoints.nvim/SKILL.md`)
