# Plugin.lua.plugins.git-conflict API Reference

This file is generated for source `lua/plugins/git-conflict.lua`.
...
## Module API (`plugins.git-conflict`)
...
- `akinsho/git-conflict.nvim` (skill: `skills/git-conflict.nvim/SKILL.md`)
