# Plugin.flash API Reference

This file is generated for source `lua/plugins/flash.lua`.
...
- `flash` (skill: `.agents/skills/flash.nvim/SKILL.md`)

- `folke/flash.nvim` (skill: `.agents/skills/flash.nvim/SKILL.md`)
