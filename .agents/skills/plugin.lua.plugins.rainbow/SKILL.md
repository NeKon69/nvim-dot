# Plugin.lua.plugins.rainbow API Reference

This file is generated for source `lua/plugins/rainbow.lua`.
...
- `HiPhish/rainbow-delimiters.nvim` (skill: `skills/rainbow-delimiters.nvim/SKILL.md`)
