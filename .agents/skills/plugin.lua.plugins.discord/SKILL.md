# Plugin.lua.plugins.discord API Reference

This file is generated for source `lua/plugins/discord.lua`.
...
- `andweeb/presence.nvim` (skill: `skills/presence.nvim/SKILL.md`)
