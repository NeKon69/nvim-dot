# Plugin.lua.plugins.peek API Reference

This file is generated for source `lua/plugins/peek.lua`.
...
- `peek` (skill: `skills/peek.nvim/SKILL.md`)

- `toppair/peek.nvim` (skill: `skills/peek.nvim/SKILL.md`)
