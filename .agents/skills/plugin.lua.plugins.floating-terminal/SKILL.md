# Plugin.lua.plugins.floating-terminal API Reference

This file is generated for source `lua/plugins/floating-terminal.lua`.
...
## Module API (`plugins.floating-terminal`)
...
- `akinsho/toggleterm.nvim` (skill: `skills/toggleterm.nvim/SKILL.md`)
