# Plugin.lua.plugins.formatting API Reference
...
- `conform` (skill: `skills/conform.nvim/SKILL.md`)

- `lint`

- `mfussenegger/nvim-lint` (skill: `skills/nvim-lint/SKILL.md`)

- `stevearc/conform.nvim` (skill: `skills/conform.nvim/SKILL.md`)
