# Plugin.lua.plugins.smart-splits API Reference
...
- `mrjones2014/smart-splits.nvim` (skill: `skills/smart-splits.nvim/SKILL.md`)

- `smart-splits` (skill: `skills/smart-splits.nvim/SKILL.md`)
