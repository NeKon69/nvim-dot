# Plugin.lua.plugins.dropbar API Reference

This file is generated for source `lua/plugins/dropbar.lua`.
...
- `Bekaboo/dropbar.nvim` (skill: `skills/dropbar.nvim/SKILL.md`)

- `dropbar.api`

- `nvim-telescope/telescope-fzf-native.nvim` (skill: `skills/telescope-fzf-native.nvim/SKILL.md`)
