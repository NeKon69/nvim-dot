# Plugin.smart-splits API Reference

This file is generated for source `lua/plugins/smart-splits.lua`.
...
## Module API (`plugins.smart-splits`)
...
- `mrjones2014/smart-splits.nvim` (skill: `.agents/skills/smart-splits.nvim/SKILL.md`)

- `smart-splits` (skill: `.agents/skills/smart-splits.nvim/SKILL.md`)
