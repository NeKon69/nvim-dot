# Plugin.editing API Reference

This file is generated for source `lua/plugins/editing.lua`.
...
- `kylechui/nvim-surround` (skill: `.agents/skills/nvim-surround/SKILL.md`)

- `numToStr/Comment.nvim` (skill: `.agents/skills/Comment.nvim/SKILL.md`)

- `windwp/nvim-autopairs` (skill: `.agents/skills/nvim-autopairs/SKILL.md`)
