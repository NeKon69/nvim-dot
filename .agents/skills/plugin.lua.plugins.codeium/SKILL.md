# Plugin.lua.plugins.codeium API Reference

This file is generated for source `lua/plugins/codeium.lua`.
...
- `Exafunction/windsurf.nvim` (skill: `skills/windsurf.nvim/SKILL.md`)
