# Plugin.lua.plugins.noice API Reference

This file is generated for source `lua/plugins/noice.lua`.
...
- `folke/noice.nvim` (skill: `skills/noice.nvim/SKILL.md`)
