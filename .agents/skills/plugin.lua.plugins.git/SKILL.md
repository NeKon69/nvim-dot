# Plugin.lua.plugins.git API Reference

This file is generated for source `lua/plugins/git.lua`.
...
- `kdheepak/lazygit.nvim` (skill: `skills/lazygit.nvim/SKILL.md`)
...
- `telescope` (skill: `skills/telescope.nvim/SKILL.md`)
