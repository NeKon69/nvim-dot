# Plugin.mason API Reference

This file is generated for source `lua/plugins/mason.lua`.
...
- `mason` (skill: `.agents/skills/mason.nvim/SKILL.md`)
...
- `williamboman/mason.nvim` (skill: `.agents/skills/mason.nvim/SKILL.md`)
