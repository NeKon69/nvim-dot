# Plugin.lua.plugins.trouble API Reference

This file is generated for source `lua/plugins/trouble.lua`.
...
- `folke/trouble.nvim` (skill: `skills/trouble.nvim/SKILL.md`)
